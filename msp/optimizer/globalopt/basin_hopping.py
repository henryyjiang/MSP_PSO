...
class BasinHoppingBatch(BasinHoppingBase):
    ...
    def predict(self, structures, objective_func, cell_relax=True, topk=1, batch_size=4, log_per=0, lr=.2, density=.2, num_atoms_perturb=1, num_unique=4, dynamic_temp=False, dynamic_dr=False):
        """
